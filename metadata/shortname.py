...
roles = {
    ...
    1112: ["托帕&账账", "topaz", "托帕", "账账", "托帕和账账", "账账启动器"],
    1201: ["青雀", "qingque", "克莱茵", "QQ"],
    1202: ["停云", "tingyun", "屑狐狸", "骚狐狸", "停运"],
    1203: ["罗刹", "luocha", "主教"],
    1204: ["景元", "jingyuan", "云骑将军", "闭目将军"],
    1205: ["刃", "blade", "应星", "应星哥", "阿刃", "点刀", "点刀哥", "笑面小黑龙"],
    1206: ["素裳", "sushang", "李素裳", "李大枕头"],
    1207: ["驭空", "yukong", "星火之狐", "司舵"],
    1208: ["符玄", "fuxuan", "typec"],
    1209: ["彦卿", "yanqing", "马彦卿", "老马", "燕青"],
    1210: ["桂乃芬", "guinaifen"],
    1211: ["白露", "bailu", "衔药龙女", "小龙女", "龙女"],
    1212: ["镜流", "jingliu"],
    1213: ["丹恒•饮月", "danhengil", "饮月君", "饮月", "龙丹"],
    1214: ["雪衣", "xueyi"],
    1215: ["寒鸦", "hanya"],
    1217: ["藿藿", "huohuo"],
    1302: ["银枝", "argenti"],
    1303: ["阮•梅", "ruanmei", "阮梅"],
    1305: ["真理医生", "drratio", "真理", "义父"],
    1306: ["花火", "sparkle"],
    1307: ["黑天鹅", "blackswan"],
    1312: ["米沙", "misha"],
}
