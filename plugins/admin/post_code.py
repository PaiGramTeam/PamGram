...
POST_TEMPLATE = """<b>《崩坏：星穹铁道》%s 版本前瞻特别节目兑换码</b>

国服：
<code>%s</code> - 星琼 ×100，信用点 x50000
<code>%s</code> - 星琼 ×100，漫游指南 x5
<code>%s</code> - 星琼 ×100，提纯以太 x4
...
class PostCode(Plugin.Conversation):
    ...
    SUBJECT_RE = re.compile(r"】(\d+\.\d+)版本前瞻讨论活动开启")
