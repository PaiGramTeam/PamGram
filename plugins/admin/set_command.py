...
class SetCommandPlugin(Plugin):
    ...
    async def set_command(self, update: "Update", context: "ContextTypes.DEFAULT_TYPE"):
        ...
        group_command = [
            ...
            BotCommand("challenge_boss", "末日幻影信息查询"),
            BotCommand("challenge_boss_history", "末日幻影历史信息查询"),
            BotCommand("challenge_peak", "异相仲裁信息查询"),
            BotCommand("challenge_peak_history", "异相仲裁历史信息查询"),
