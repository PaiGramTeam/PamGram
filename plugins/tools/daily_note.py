...
class DailyNoteSystem(Plugin):
    ...
    @staticmethod
    def get_resin_notice(user: DailyNoteTaskUser, notes: Union["StarRailNote", "StarRailNoteWidget"]) -> str:
        notice = None
    ...
    @staticmethod
    def get_expedition_notice(user: DailyNoteTaskUser, notes: Union["StarRailNote", "StarRailNoteWidget"]) -> str:
        notice = None
    ...
    @staticmethod
    def get_daily_notice(user: DailyNoteTaskUser, notes: Union["StarRailNote", "StarRailNoteWidget"]) -> str:
        notice = None
